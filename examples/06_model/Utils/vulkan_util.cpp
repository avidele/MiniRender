...
void VulkanContextManager::createLogicalDevice() {
    ...
    // --- End Enable Extended Dynamic State Feature ---


    VkDeviceCreateInfo create_info{};
    create_info.sType = VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO;
    // --- Chain the feature struct ---
    create_info.pNext = &extended_dynamic_state_features;
    // --- End Chain the feature struct ---
    ...
    std::vector<const char*> device_extensions = {
        VK_KHR_SWAPCHAIN_EXTENSION_NAME,
        // Ensure the extension is requested (already present in checkDeviceExtensionSupport)
        VK_EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME
    };
#if VKB_ENABLE_PORTABILITY
    device_extensions.push_back(VK_KHR_PORTABILITY_SUBSET_EXTENSION_NAME);
    // Required for VK_DYNAMIC_STATE_PRIMITIVE_TOPOLOGY_EXT - Already added above
...
void Renderer::createTextureImage() {
    ...
    std::string image_path_str = "Obj/Weapon.png";
